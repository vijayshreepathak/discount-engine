/**
 * Empty state with guidance and optional call-to-action.
 */
...
export default function EmptyState({ variant = 'default', title, description, action }) {
  return (
    <div className={`empty empty--${variant}`} role="status">
      <div className="empty__visual" aria-hidden>
        <span className="empty__ring" />
        <span className="empty__glyph">{ICONS[variant] ?? ICONS.default}</span>
      </div>
